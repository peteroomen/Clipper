...
## 68. M10.4 — the Mesa/Boogie Dual Rectifier: the SEVENTH amp voice, and the FIRST one transcribed from a complete factory drawing set
...
4. **The power shortfall** (§68.7) — open, attributed, deliberately not fitted.
